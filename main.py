...
from pyweb1io import start_server
...
async def main():
    ...
    nickname = await input("Enter the chat", required=True, placeholder="Enter your name",
                           validate=lambda n: "This nickname is taken!" if n in online_users or n == '📢' else None)
